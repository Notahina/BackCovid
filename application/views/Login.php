...
<html lang="en">
  <head>
  	<title>Authentification OMS</title>
    <meta charset="utf-8">
			...
			<div class="row justify-content-center">
                ...
                <form action="" class="login-form" method="post">
                    ...
                    <?php 
                        ...
                        {   ?>
                            <div class="form-group">
                                <p style="text-align:center;color:red"><?php echo $val?>
                            </div>
                    <?php    }
                    ?>
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary rounded submit p-3 px-5">Valider</button>
                    </div>
